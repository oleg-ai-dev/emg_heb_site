  ...
  return (
    <article dir="rtl" lang="he" className="prose prose-lg prose-sky max-w-none mx-auto">
      ...
      <p className="text-lg leading-relaxed mb-6">
        בשנים האחרונות, תחום הנוירולוגיה עובר מהפכה של ממש בזכות שילוב טכנולוגיות מתקדמות של <strong>בינה מלאכותית (AI)</strong> ולמידת מכונה (Machine Learning). אחד התחומים שבהם השינוי הזה מורגש במיוחד הוא ניתוח תוצאות בדיקת <strong>EMG</strong> (אלקטרומיוגרפיה) – בדיקה קריטית לאבחון מחלות נוירומוסקולריות כמו ALS, מיאסטניה גרביס, מיופתיות דלקתיות, ניוון שרירים, תסמונות לחץ עצבי ועוד.
      </p>
      <blockquote className="border-r-4 border-medblue-dark bg-medblue/10 p-4 rounded-lg mb-8">
        אם בעבר ניתוח אותות EMG היה תלוי כמעט לחלוטין במומחיות של הרופא, כיום אלגוריתמים חכמים מסוגלים לזהות דפוסים, לאבחן מחלות, ולספק תובנות מדויקות – לעיתים אף יותר מהעין האנושית.
      </blockquote>
      <p>
      ...
      <blockquote className="bg-orange-100 border-r-4 border-orange-400 p-4 rounded-lg my-6">
        כאן נכנסת לתמונה הבינה המלאכותית: אלגוריתמים של למידת מכונה ו-deep learning מסוגלים "ללמוד" מאלפי בדיקות קודמות, לזהות דפוסים מורכבים, ולסווג אותות EMG בדיוק מרשים.
      </blockquote>
      <p>
        מחקרים עדכניים מראים שאלגוריתמים כאלה מגיעים לרמות דיוק של 90-99% בזיהוי מחלות כמו ALS, מיופתיות, נוירופתיות ועוד – לעיתים אף עולים על מומחים אנושיים.
      </p>
      ...
      <h3 className="!text-xl !font-bold text-medblue-dark mt-6 mb-3">
