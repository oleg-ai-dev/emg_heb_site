  ...
  return (
    <div className="space-y-6">
      ...
      <ul className="list-disc pr-8 space-y-3 mt-4">
        ...
        <li className="mb-4"> {/* Added bottom margin to list item */}
      ...
      <h3 className="text-xl font-semibold text-medblue-dark mt-6 mb-3">שאלה: האם בדיקת EMG יכולה לאבחן ALS בוודאות לבדה?</h3> {/* Changed margin */}
      <p className="leading-relaxed">
      ...
      <h3 className="text-xl font-semibold text-medblue-dark mt-6 mb-3">שאלה: אני חווה קפיצות שרירים (פסיקולציות) לפעמים. האם זה אומר שיש לי ALS?</h3> {/* Changed margin */}
      <p className="leading-relaxed">
      ...
      <h3 className="text-xl font-semibold text-medblue-dark mt-6 mb-3">שאלה: מה ההבדל העיקרי בין ALS שמתחיל בגפיים (לימבי) ל-ALS שמתחיל בפה ובלוע (בולברי)?</h3> {/* Changed margin */}
      <p className="leading-relaxed">
      ...
      <h3 className="text-xl font-semibold text-medblue-dark mt-6 mb-3">שאלה: האם ALS היא מחלה כואבת?</h3> {/* Changed margin */}
      <p className="leading-relaxed">
      ...
      <h3 className="text-xl font-semibold text-medblue-dark mt-6 mb-3">שאלה: מהי תוחלת החיים הממוצעת עם ALS?</h3> {/* Changed margin */}
      <p className="leading-relaxed">
      ...
      <h3 className="text-xl font-semibold text-medblue-dark mt-6 mb-3">שאלה: האם יש טיפול ל-ALS?</h3> {/* Changed margin */}
      <p className="leading-relaxed">
