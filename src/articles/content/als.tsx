  ...
  return (
    <article dir="rtl" lang="he" className="prose prose-lg prose-sky max-w-none mx-auto">
      ...
      <p className="text-lg leading-relaxed mb-6">
        שמעתם פעם על ALS? אולי בשם מחלת לו גריג? זה די מפחיד, נכון? אז מה <em>זה</em> הדבר הזה, באמת? טרשת צידית אמיוטרופית, או ALS בקיצור, היא מחלה לא פשוטה בכלל. היא פוגעת בעצבים ששולטים על השרירים שלנו, אלו שמאפשרים לנו לזוז, לדבר, לבלוע, ואפילו לנשום. תחשבו על זה כמו על חוטי חשמל שהולכים ומתקלקלים לאט לאט. העצבים האלה, שנקראים נוירונים מוטוריים, נמצאים גם במוח (העליונים) וגם בחוט השדרה (התחתונים). ב-ALS, גם אלה וגם אלה נפגעים ופשוט מפסיקים לעבוד עם הזמן.
      </p>
      <blockquote className="border-r-4 border-medblue-dark bg-medblue/10 p-4 rounded-lg mb-8">
        התוצאה? השרירים לא מקבלים את הפקודות מהמוח, אז הם נחלשים, מתחילים להתכווץ בצורה מוזרה (כמו קפיצות קטנות מתחת לעור, שנקראות פסיקולציות), ובסופו של דבר הם גם מתנוונים, כאילו מתכווצים כזה. זה תהליך הדרגתי, לא משהו שקורה ביום אחד, אבל הוא כן מתקדם.
      </blockquote>
      <p>
        הדבר המוזר, ואיכשהו גם המנחם קצת, זה ש-ALS פוגע בעיקר בתנועה. לרוב, המחשבה, הזיכרון, החושים (ראייה, שמיעה, מישוש), והתפקודים האוטומטיים כמו פעילות הלב או העיכול נשארים בסדר גמור. למרות שכן, אצל חלק מהאנשים, בערך חצי, יכולים להיות גם שינויים קוגניטיביים או התנהגותיים מסוימים, אבל זה לא הכלל.
      </p>
      <p>
      ...
      <h2 className="!text-2xl !font-bold text-medblue-dark mt-10 mb-4">הפנים השונות של ALS: זה לא תמיד אותו הדבר</h2>
      <p>
      ...
      <blockquote className="bg-sky-50 border-r-4 border-sky-400 p-4 rounded-lg my-6">
        למה זה חשוב לדעת איפה זה התחיל? כי זה עוזר לרופאים להבין קצת יותר טוב איך המחלה עלולה להתקדם אצל אותו אדם ספציפי. אבל חשוב לזכור, לא משנה איפה זה התחיל, בסופו של דבר ALS נוטה להתפשט ולהשפיע על כל השרירים הרצוניים בגוף.
      </blockquote>

      <hr className="my-8" />

      <h2 className="!text-2xl !font-bold text-medblue-dark mt-10 mb-4">למה ALS קורה? שאלת המיליון דולר</h2>
      <p>
      ...
      <h2 className="!text-2xl !font-bold text-medblue-dark mt-10 mb-4">לזהות את הסימנים: איך ALS נראה בהתחלה?</h2>
      <p>
      ...
      <ul className="my-4">
        ...
        <li><strong>פסיקולציות:</strong> אלו קפיצות קטנות ולא רצוניות של סיבי שריר בודדים מתחת לעור. זה נראה כמו תולעים קטנות שזזות. הרבה אנשים בריאים חווים פסיקולציות פה ושם (במיוחד בעפעף או אחרי מאמץ), אבל ב-ALS הן נפוצות מאוד, מפושטות, ובאות יחד עם חולשה ואטרופיה. זה השילוב החשוב.</li>
      ...
      <h2 className="!text-2xl !font-bold text-medblue-dark mt-10 mb-4">EMG: עבודת הבילוש באבחון ALS</h2>
      <p>
      ...
      <p>
        מה ה-EMG מחפש ספציפית ב-ALS? הוא מחפש סימנים שהשריר איבד את הקשר העצבי שלו (קוראים לזה <strong>דנרבציה</strong>) וסימנים שהעצבים הבריאים שנשארו מנסים לפצות על זה ו"לאמץ" סיבי שריר יתומים (קוראים לזה <strong>ראינרבציה</strong>). הממצאים האלה מעידים באופן די ברור על נזק לנוירונים המוטוריים התחתונים. כשמוצאים סימנים כאלה <em>במספר אזורים בגוף</em> (למשל, גם ביד וגם ברגל, או גם בגפיים וגם באזור הפנים/לשון), זה מחזק מאוד את החשד ל-ALS, כי ALS היא מחלה מפושטת של הנוירונים המוטוריים.
      </p>
      <blockquote className="bg-orange-100 border-r-4 border-orange-400 p-4 rounded-lg my-6">
        בדיקת EMG היא לא הכי נעימה, המחטים קצת דוקרות, אבל היא נסבלת וכל כך חשובה שזה שווה את זה. היא גם עוזרת לשלול מחלות אחרות שיכולות לחקות ALS, כמו בעיות בעמוד השדרה הצווארי, נוירופתיות מסוימות או מחלות שריר אחרות.
      </blockquote>
      <p>
        אני זוכר מקרה של מטופל שהגיע עם חולשה קלה ביד ימין וקצת קפיצות שרירים ברגל. הבדיקה הנוירולוגית הראתה כמה סימנים מחשידים, אבל ה-EMG היה זה שבאמת הטה את הכף. מצאנו סימני דנרבציה וראינרבציה לא רק ביד הפגועה, אלא גם ברגל השנייה ובשרירי הגב, אזורים שהוא בכלל לא התלונן עליהם. התמונה הזו ב-EMG, יחד עם הסיפור והבדיקה הקלינית, עזרה לנו להגיע לאבחנה של ALS בשלב יחסית מוקדם. זה לא תמיד ככה קל, אבל ה-EMG הוא כלי עצום.
      </p>

      <hr className="my-8" />

      <h2 className="!text-2xl !font-bold text-medblue-dark mt-10 mb-4">מה ה-EMG באמת מראה ב-ALS? נכנסים לפרטים</h2>
      <p>
      ...
      <ul className="my-4">
        <li>
          <strong>פעילות ספונטנית כשהשריר רפוי:</strong> בשריר בריא ורפוי לגמרי, לא אמורה להיות כמעט שום פעילות חשמלית. זה כמו רדיו שקט כשאין שידור. אבל בשריר שאיבד את העצב שלו (דנרבציה), סיבי השריר הופכים להיות רגישים מאוד ומתחילים "לירות" חשמל באופן ספונטני, גם בלי פקודה מהעצב. ב-EMG זה נראה כמו:
      ...
      <blockquote className="bg-sky-50 border-r-4 border-sky-400 p-4 rounded-lg my-6">
        אז מה השורה התחתונה? ה-EMG ב-ALS מראה שילוב של שני תהליכים שקורים במקביל: <strong>נזק עצבי פעיל ומתמשך (דנרבציה)</strong>, שמתבטא בפיברילציות ו-PSWs, ו<strong>ניסיונות תיקון ופיצוי של העצבים שנותרו (ראינרבציה)</strong>, שמתבטאים ב-MUAPs גדולים, ארוכים ופוליפאזיים. הכי חשוב: למצוא את השילוב הזה של <strong>דנרבציה פעילה וכרונית</strong> במספר אזורים בגוף.
      </blockquote>
      ...
      <h2 className="!text-2xl !font-bold text-medblue-dark mt-10 mb-4">להרכיב את הפאזל: תהליך האבחון של ALS</h2>
      <p>
      ...
      <h2 className="!text-2xl !font-bold text-medblue-dark mt-10 mb-4">אחרי האבחנה: מה קורה עכשיו?</h2>
      <p>
      ...
      <h2 className="!text-2xl !font-bold text-medblue-dark mt-10 mb-4">שאלות נפוצות (FAQ)</h2>

      <h3 className="!text-xl !font-bold text-medblue-dark mt-6 mb-3">האם בדיקת EMG יכולה לאבחן ALS בוודאות לבדה?</h3>
      <p>
      ...
      <h3 className="!text-xl !font-bold text-medblue-dark mt-6 mb-3">אני חווה קפיצות שרירים (פסיקולציות) לפעמים. האם זה אומר שיש לי ALS?</h3>
      <p>
      ...
      <h3 className="!text-xl !font-bold text-medblue-dark mt-6 mb-3">מה ההבדל העיקרי בין ALS שמתחיל בגפיים (לימבי) ל-ALS שמתחיל בפה ובלוע (בולברי)?</h3>
      <p>
      ...
      <h3 className="!text-xl !font-bold text-medblue-dark mt-6 mb-3">האם ALS היא מחלה כואבת?</h3>
      <p>
      ...
      <h3 className="!text-xl !font-bold text-medblue-dark mt-6 mb-3">מהי תוחלת החיים הממוצעת עם ALS?</h3>
      <p>
      ...
      <h3 className="!text-xl !font-bold text-medblue-dark mt-6 mb-3">האם יש טיפול ל-ALS?</h3>
      <p>
