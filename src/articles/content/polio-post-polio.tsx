...
const PolioPostPolioContent = () => {
  return (
    <div className="space-y-6">
      ...
      <h2 className="text-2xl font-semibold text-medblue-dark mt-8 mb-4">פוליו (פוליומיאליטיס): המחלה המקורית והשפעותיה</h2> {/* Increased top margin */}
      <p className="leading-relaxed">
      ...
      <h2 className="text-2xl font-semibold text-medblue-dark mt-8 mb-4">תסמונת פוסט-פוליו (PPS): האויב השקט שמופיע מאוחר</h2> {/* Increased top margin */}
      <p className="leading-relaxed">
      ...
      <h2 className="text-2xl font-semibold text-medblue-dark mt-8 mb-4">בדיקת EMG: איך היא עוזרת להבין מה קורה בשרירים ובעצבים?</h2> {/* Increased top margin */}
      <p className="leading-relaxed">
      ...
      <h2 className="text-2xl font-semibold text-medblue-dark mt-8 mb-4">ממצאי EMG בפוליו חריף: מה רואים כשהנגיף תוקף?</h2> {/* Increased top margin */}
      <p className="leading-relaxed">
      ...
      <h2 className="text-2xl font-semibold text-medblue-dark mt-8 mb-4">ממצאי EMG בתסמונת פוסט-פוליו: הצלקות הישנות והבעיות החדשות</h2> {/* Increased top margin */}
      <p className="leading-relaxed">
      ...
      <h2 className="text-2xl font-semibold text-medblue-dark mt-8 mb-4">היתרונות של EMG באבחון ומעקב: לא רק לזהות, גם לנהל</h2> {/* Increased top margin */}
      <p className="leading-relaxed">
      ...
      <h2 className="text-2xl font-semibold text-medblue-dark mt-8 mb-4">טיפול וניהול פוליו ופוסט-פוליו: מה אפשר לעשות?</h2> {/* Increased top margin */}
      <p className="leading-relaxed">
      ...
      <h3 className="text-xl font-semibold text-medblue-dark mt-6 mb-3">שאלה: מה ההבדל בין פוליו לתסמונת פוסט-פוליו (PPS)?</h3> {/* Changed margin */}
      <p className="leading-relaxed">
      ...
      <h3 className="text-xl font-semibold text-medblue-dark mt-6 mb-3">שאלה: האם תסמונת פוסט-פוליו מדבקת?</h3> {/* Changed margin */}
      <p className="leading-relaxed">
      ...
      <h3 className="text-xl font-semibold text-medblue-dark mt-6 mb-3">שאלה: מי נמצא בסיכון לפתח PPS?</h3> {/* Changed margin */}
      <p className="leading-relaxed">
      ...
      <h3 className="text-xl font-semibold text-medblue-dark mt-6 mb-3">שאלה: האם בדיקת EMG כואבת?</h3> {/* Changed margin */}
      <p className="leading-relaxed">
      ...
      <h3 className="text-xl font-semibold text-medblue-dark mt-6 mb-3">שאלה: מהם הממצאים העיקריים ב-EMG שמצביעים על PPS?</h3> {/* Changed margin */}
      <p className="leading-relaxed">
      ...
      <h3 className="text-xl font-semibold text-medblue-dark mt-6 mb-3">שאלה: האם יש טיפול שמרפא PPS?</h3> {/* Changed margin */}
      <p className="leading-relaxed">
      ...
      <h3 className="text-xl font-semibold text-medblue-dark mt-6 mb-3">שאלה: האם פעילות גופנית מומלצת לאנשים עם PPS?</h3> {/* Changed margin */}
      <p className="leading-relaxed">
