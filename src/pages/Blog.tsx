...
const blogPosts = [
  {
    ...
    date: '19 באפריל, 2025',
    readTime: '14 דקות',
    image: '/articles/images/emg-vs-ncs-explained.jpg',
    category: 'בדיקות EMG', // Assigning a relevant category
    keywords: [
  ...
  },
  {
    ...
    excerpt: 'מסע ההחלמה מגיאן-בארה: התמודדות עם אתגרים ארוכי טווח כמו עייפות כרונית וכאב נוירופתי, השפעות פסיכולוגיות, אסטרטגיות ניהול וחזרה לחיים.',
    date: '18 באפריל, 2025',
    readTime: '15 דקות',
    image: '/articles/images/gbs.jpg', // Updated image path
    category: 'שיקום ומעקב', // Added category
    keywords: [
