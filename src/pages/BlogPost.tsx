...
const blogMetadata: Record<string, BlogPostMetadata> = {
  ...
  'emg-vs-ncs-explained': {
    id: 'emg-vs-ncs-explained',
    title: 'EMG מול NCS: הבנת ההבדלים והחשיבות של כל בדיקה',
    date: '19 באפריל, 2025', // Today's date
    readTime: '14 דקות', // Estimated read time
    image: '/articles/images/emg-vs-ncs-explained.jpg',
    description: 'מדריך מקיף להבנת ההבדלים בין בדיקת EMG לבדיקת NCS, חשיבותן המשלימה באבחון מחלות עצב ושריר, ומה לצפות במהלך הבדיקות.',
    keywords: [
