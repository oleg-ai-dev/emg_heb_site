...
const blogPosts: Record<string, BlogPostData> = {
  'guillain-barre-syndrome': {
    ...
    keywords: [
      ...
      'סימפטומים של גיאן-בארה',
      'החלפת פלסמה גיאן-בארה',
      'אימונוגלובולינים ורידיים',
      'שיקום לאחר גיאן-בארה',
      'חולשת שרירים סימטרית',
      'מוליכות עצבית בגיאן-בארה',
      'תסמונת גיאן-בארה לאחר זיהום',
      'אבחנה מבדלת תסמונת גיאן-בארה',
      'בעיות נשימה בגיאן-בארה',
      'זמן החלמה מגיאן-בארה',
      'סיבוכים של תסמונת גיאן-בארה',
      'ניטור תסמונת גיאן-בארה',
      'תחזית החלמה מתסמונת גיאן-בארה',
      'סוגים של תסמונת גיאן-בארה'
    ],
    content: (
      <>
        <h2>מהי תסמונת גיאן-בארה?</h2>
        <p>
        ...
        <h2>הסוגים העיקריים של תסמונת גיאן-בארה</h2>
        <p>קיימים מספר תתי-סוגים של התסמונת, המתבטאים בדפוסים שונים של פגיעה עצבית:</p>
        ...
        <h2>גורמים ומחוללים של תסמונת גיאן-בארה</h2>
        <p>
        ...
        <p>זיהומים שכיחים שקודמים להתפתחות GBS כוללים:</p>
        <ul className="list-disc pr-6 space-y-2">
        ...
        <h2>סימני תסמונת גיאן-בארה</h2>
        <p>הסימנים של תסמונת גיאן-בארה מתפתחים במהירות, תוך ימים או שבועות, וכוללים:</p>
        <ul className="list-disc pr-6 space-y-2">
        ...
        <h2>יתרונות בדיקת EMG בניהול תסמונת גיאן-בארה</h2>
        <p>בדיקת EMG מציעה מספר יתרונות משמעותיים בניהול תסמונת גיאן-בארה:</p>
        <ul className="list-disc pr-6 space-y-2">
        ...
        <h2>טיפול בתסמונת גיאן-בארה</h2>
        <p>הטיפול בתסמונת גיאן-בארה מתמקד בהאצת תהליך ההחלמה ומניעת סיבוכים:</p>

        <h3>טיפולים אימונומודולטוריים:</h3>
        <ul className="list-disc pr-6 space-y-2">
        ...
        <h2>שיקום והחלמה מתסמונת גיאן-בארה</h2>
        <p>השיקום הוא מרכיב קריטי בהחלמה מתסמונת גיאן-בארה וכולל:</p>
        <ul className="list-disc pr-6 space-y-2">
        ...
        <h2>אתגרים וסיבוכים ארוכי טווח</h2>
        <p>למרות שרוב החולים משתפרים עם הזמן, חלקם עלולים להתמודד עם אתגרים ארוכי טווח:</p>
        <ul className="list-disc pr-6 space-y-2">
        ...
        <h2>מחקרים עדכניים וכיוונים עתידיים</h2>
        <p>תחום המחקר בתסמונת גיאן-בארה מתקדם במספר כיוונים מבטיחים:</p>
        <ul className="list-disc pr-6 space-y-2">
        ...
        <h2>סיכום: חשיבות האבחון המוקדם והמדויק</h2>
        <p>
  ...
  'carpal-tunnel-syndrome': {
    ...
    keywords: [
      ...
      'תרגילים לתעלה קרפלית',
      'סיבות לתסמונת התעלה הקרפלית',
      'חולשה בכף היד',
      'הקלה על כאבי כף יד',
      'לחץ על העצב המדיאני',
      'אלקטרומיוגרפיה לכף יד',
      'סימפטומים של תעלה קרפלית',
      'מניעת תסמונת התעלה הקרפלית',
      'הזרקות קורטיזון לכף יד',
      'שיקום לאחר ניתוח תעלה קרפלית',
      'בדיקת מוליכות עצבית לכף יד'
    ],
    content: (
      <>
        <h2>מהי תסמונת התעלה הקרפלית?</h2>
        <p>
        ...
        <h2>סימפטומים של תעלה קרפלית</h2>
        <p>אנשים עם תסמונת התעלה הקרפלית חווים מגוון סימפטומים:</p>
        <ul className="list-disc pr-6 space-y-2">
        ...
        <p>הסימפטומים מתחילים בהדרגה ומחמירים עם הזמן. רבים מתעוררים בלילה בשל תחושת נימול וכאב.</p>

        <h2>גורמי סיכון לתסמונת התעלה הקרפלית</h2>
        <p>מספר גורמים מגבירים את הסיכון לפתח את המצב:</p>
        <ul className="list-disc pr-6 space-y-2">
        ...
        <h2>יתרונות בדיקת EMG באבחון</h2>
        <p>בדיקת EMG מספקת מידע חיוני ומציעה יתרונות משמעותיים:</p>
        <ul className="list-disc pr-6 space-y-2">
        ...
        <h2>אפשרויות טיפול בתסמונת התעלה הקרפלית</h2>
        <p>הטיפול תלוי בחומרת המצב ומידת השפעתו על חיי היומיום:</p>

        <h3>טיפולים שמרניים</h3>
        <ul className="list-disc pr-6 space-y-2">
        ...
        <h2>מניעת תסמונת התעלה הקרפלית</h2>
        <p>צעדים מניעתיים יכולים לסייע בהפחתת הסיכון להתפתחות המצב:</p>
        <ul className="list-disc pr-6 space-y-2">
        ...
        <h2>שיקום לאחר ניתוח תעלה קרפלית</h2>
        <p>תהליך השיקום לאחר ניתוח כולל מספר שלבים:</p>
        <ul className="list-disc pr-6 space-y-2">
        ...
        <h2>חידושים בתחום הטיפול בתסמונת התעלה הקרפלית</h2>
        <p>מחקרים עדכניים מתמקדים במספר כיוונים:</p>
        <ul className="list-disc pr-6 space-y-2">
  ...
  'תסמונות-לחץ-עצבים': {
    ...
    date: '18 במרץ, 2025',
    readTime: '15 דקות',
    image: '/articles/images/תסמונות לחץ על עצבים פריפריים מדריך מקיף לאבחון וטיפול.jpg',
    ...
    keywords: [
      ...
      'לחץ על עצב רדיאלי',
      'נוירופתיה דחיסתית',
      'כאבים בעצבים פריפריים',
      'נימול בגפיים',
      'חולשת שרירים בגפיים',
      'טיפול בלחץ על עצבים',
      'ניתוח לשחרור עצב',
      'פיזיותרפיה לעצבים לחוצים',
      'מניעת תסמונות לחץ עצבי',
      'אלקטרומיוגרפיה לעצבים פריפריים',
      'תסמונת פירמידליס',
      'לחץ על עצב סופרסקפולרי',
      'תסמונת מוצא החזה',
      'שיקום לאחר פגיעה עצבית'
    ],
    content: (
      <>
        <h2>מבוא לתסמונות לחץ על עצבים פריפריים</h2>
        <p>
        ...
        <h2>סוגים עיקריים של תסמונות לחץ על עצבים</h2>
        <p>קיימים מספר סוגים נפוצים של תסמונות לחץ על עצבים פריפריים:</p>

        <h3>1. תסמונת התעלה הקרפלית (Carpal Tunnel Syndrome)</h3>
        <p>
        ...
        <h3>2. תסמונת התעלה האולנרית (Cubital Tunnel Syndrome)</h3>
        <p>
        ...
        <h3>3. לחץ על העצב הפרונאלי (Peroneal Nerve Compression)</h3>
        <p>
        ...
        <h3>4. תסמונת מנהרת הטרסוס (Tarsal Tunnel Syndrome)</h3>
        <p>
        ...
        <h3>5. לחץ על העצב הרדיאלי (Radial Nerve Compression)</h3>
        <p>
        ...
        <h3>6. תסמונת מוצא החזה (Thoracic Outlet Syndrome)</h3>
        <p>
        ...
        <h3>7. תסמונת פירמידליס (Piriformis Syndrome)</h3>
        <p>
        ...
        <h2>גורמי סיכון לתסמונות לחץ על עצבים</h2>
        <p>מספר גורמים עלולים להגביר את הסיכון להתפתחות תסמונות לחץ על עצבים:</p>
        <ul className="list-disc pr-6 space-y-2">
        ...
        <h2>סימפטומים אופייניים לתסמונות לחץ על עצבים</h2>
        <p>למרות שהסימפטומים משתנים בהתאם לעצב הנפגע, קיימים מספר סימנים אופייניים:</p>
        <ul className="list-disc pr-6 space-y-2">
        ...
        <h2>בדיקת EMG באבחון תסמונות לחץ על עצבים</h2>
        <p>
        ...
        <h2>יתרונות בדיקת EMG באבחון תסמונות לחץ</h2>
        <p>בדיקת EMG מציעה מספר יתרונות משמעותיים:</p>
        <ul className="list-disc pr-6 space-y-2">
        ...
        <h2>אפשרויות טיפול בתסמונות לחץ על עצבים</h2>
        <p>הטיפול בתסמונות לחץ על עצבים תלוי בסוג התסמונת, חומרתה ומשך הסימפטומים:</p>
        ...
        <h2>שיקום לאחר טיפול בתסמונות לחץ על עצבים</h2>
        <p>תהליך השיקום הוא חלק חיוני מההחלמה וכולל:</p>
        <ul className="list-disc pr-6 space-y-2">
        ...
        <h2>מניעת תסמונות לחץ על עצבים</h2>
        <p>צעדים מניעתיים יכולים לסייע בהפחתת הסיכון להתפתחות תסמונות לחץ:</p>
        <ul className="list-disc pr-6 space-y-2">
          <li><strong>הפסקות תכופות</strong>: בעת ביצוע פעילויות חוזרניות</li>
        ...
        <h2>חידושים בתחום האבחון והטיפול</h2>
        <p>מחקרים עדכניים מתמקדים במספר כיוונים:</p>
        <ul className="list-disc pr-6 space-y-2">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-8 text-right">
              ...
              <div className="flex flex-wrap items-center justify-end gap-4 text-sm text-gray-600">
            ...
            <div className="mt-12 bg-medblue-dark text-white p-8 rounded-lg shadow-md text-right">
              ...
              <div className="flex justify-end">
                <a 
                  href="tel:03-301-5458"
                  className="bg-orange-500 hover:bg-orange-600 text-white font-medium py-3 px-8 rounded-md flex items-center gap-2 shadow-md"
                >
